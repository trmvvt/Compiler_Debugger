...
public class SymbolTable {
  ...
  //a hashmap with Symbol as the key and Binder as the value
  ...
  */
  ...
  //new method, used to pop the top Symbol from the SymbolTable
  ...
  */
  ...
  //new method, returns the top symbol on the SymbolTable
   public Symbol getTop(){
      return top; 
  }
  
   //new method, returns the size of the table
   public int getSize(){
       return symbols.size(); 
   }
