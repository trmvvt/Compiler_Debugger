/**
 *  Description: The Symbol class is used to store all user strings along with
...
public class Symbol {
  private String name;
  private int kind;   // token kind of symbol

  public Symbol(String n, int kind) {
    name=n;
    this.kind = kind;
  }
   ...
   */
  public static Symbol symbol(String newTokenString, int kind) {
